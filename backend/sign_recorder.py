...
class SignRecorder(object):
    ...
    def process_results(self, results) -> Tuple[Tuple[str, float], bool]:
        """
        ...
        sign, confidence = self._get_sign_predicted()
        return (sign, confidence) if sign else ("", 0.0), self.is_recording
    ...
    def _get_sign_predicted(self, batch_size=5, threshold=0.5):
        ...
        confidence = count / batch_size

        if confidence < threshold:
            return "Signe inconnu", confidence
